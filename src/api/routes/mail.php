...
$app->get('/sendlinktouser/{userid}', function (Request $request, Response $response) {
    ...
    $mail->SMTPSecure = 'ssl';
    $mail->Host = "mail.noreply.com";
    $mail->SMTPAuth = true;
    $mail->SMTPKeepAlive = true; // SMTP connection will not close after each email sent, reduces SMTP overhead
    $mail->Port = 465;
    $mail->Username = 'noreply@noreply.com';
    $mail->Password = 'replyno';
    $mail->setFrom('noreply@noreply.com', 'Mail');
    $mail->addReplyTo('noreply@noreply.com', 'Mail');
                            ...
                            <tr>
                              <td align="left">
                                <table border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="https://google.com" target="_blank">Button -></a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
              ...
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="content-block">
                    <span class="apple-link">___</span>
                  </td>
                </tr>
                <tr>
                </tr>
